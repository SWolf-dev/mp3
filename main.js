...
const app = {
    ...
    durationList: JSON.parse(localStorage.getItem(DURATION_STORAGE_KEY) || `[
        ["04:30","03:01","03:44","04:20","03:24","04:31","03:28","03:22","03:44","03:08","04:15","03:53","04:07","04:13","04:42","04:08","03:17","04:05","03:11","04:16","04:04"],
                        ...
                        <div class="playlist__song-info media__left">
                            ...
                            <div class="playlist__song-thumb media__thumb mr-10" style="background: url('${song.image}') no-repeat center center / cover">
                                <div class="thumb--animate">
                                    <div class="thumb--animate-img" style="background: url('./assets/img/music-wave/icon-playing.gif') no-repeat 50% / contain">
                                    </div>
                                </div>
                                ...
                                <div class="row__item-container flex--top-left">
                                    <div class="row__item-display br-5">
                                        ...
                                        <div class="row__item-actions">
                                            ...
                                            <div class="btn--play-playlist">
                                                <div class="control-btn btn-toggle-play play-album">
                                ...
                                <div class="row__item-container flex--top-left">
                                    <div class="row__item-display br-5">
                                        ...
                                        <div class="row__item-actions">
                                            ...
                                            <div class="btn--play-playlist play-mv" >
                                                <div class="control-btn btn-toggle-play">
                                                    <i class="bi bi-play-fill icon-play"></i>
                                                </div>
                                            </div>
                ...
                <div class="charts__container">
                    <div class="grid">
                        <div class="chart__container-header mb-40">
                            <h3 class="chart__header-name">Được nghe nhiều nhất</h3>
                        </div>
    ...
    handleEvents: function() {
        ...
        const playMvs = $$('.play-mv')
        const playAlbums = $$('.play-album')
        const nowPlayingBtn = $('.now-playing')
        ...
        async function Music(){
            ...
            musics.forEach((item,index)=>{
                item.addEventListener('click',function(){
                    ...
                    sound(currentId)
                    _this.lyricId = currentId
                    _this.renderLyric(_this.lyricId)
                    ...
                    authors.forEach(author => {
                        author.innerHTML = app.html`
                            <a href="#" class="is-ghost">${data.data.songs[index].artistsNames}</a>
    ...
    loadCurrentPlaylist(playlistBtn, index) {
        if(playlistBtn) {
            if(index < 3) {
                ...
                showNotificationToast('Trang web hiện tại chưa hoàn thiện, bạn vui lòng chọn 3 playlist đã được admin sắp xếp!')
            }
        }
    },
    ...
    loadCurrentSong: function() {
        ...
        this.lyricId = this.currentSong.encodeId
        this.renderLyric(this.lyricId)
